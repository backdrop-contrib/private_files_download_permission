...
Version 2.x removes the "global" permission and implements a by-directory,
by-user and by-role system instead, to let the administrator better tweak the
...
The development was partly sponsored by http://www.cita.coop.
...
directory path you want to put under control, associating user and roles which
